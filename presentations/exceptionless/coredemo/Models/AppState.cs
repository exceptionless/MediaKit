...
{
    public class AppState : Dictionary<string, object>
    {
        public AppState()
        {
        }

        public AppState SetHttpContext(HttpContext context)
        {
            return Property("HttpContext", context);
        }
        ...
        public AppState Tag(string tag)
        {
        ...
        public AppState Value(decimal value)
        {
            base["@value"] = value;
            return this;
        }

        public AppState ManualStackingKey(string stackingKey)
        {
        ...
        public AppState Identity(string identity)
        {
        ...
        public AppState Identity(string identity, string name)
        {
        ...
        public AppState Property(string key, object value)
        {
            base[key] = value;
            return this;
        }
        ...
        public AppState MarkUnhandled(string submissionMethod = null)
        {
        ...
        /// </summary>
        public AppState MarkAsUnhandledError()
        {
        ...
        /// </summary>
        public AppState SetSubmissionMethod(string submissionMethod)
        {
